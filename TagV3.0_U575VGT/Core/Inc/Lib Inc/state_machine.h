...
#define ALL_STATE_FLAGS (STATE_TIMEOUT_FLAG | STATE_GPS_FENCE_FLAG | STATE_LOW_BATT_FLAG | STATE_CRIT_BATT_FLAG | STATE_USB_CONNECTED_FLAG | STATE_USB_DISCONNECTED_FLAG | STATE_SLEEP_MODE_FLAG | STATE_EXIT_SLEEP_MODE_FLAG | STATE_TAG_RELEASED_FLAG)
