...
#define STATE_USB_MSB_CONNECTED_FLAG	0x10
#define STATE_USB_MSB_DISCONNECTED_FLAG	0x20
#define STATE_SLEEP_MODE_FLAG			0x40
#define STATE_EXIT_SLEEP_MODE_FLAG		0x80
#define STATE_TAG_RELEASED_FLAG			0x100
#define STATE_SD_CARD_FULL_FLAG			0x200
#define STATE_ENTER_SIM_FLAG			0x400
#define STATE_EXIT_SIM_FLAG				0x800

#define DATA_OFFLOADING_SD_CLK_DIV 6
#define NORMAL_SD_CLK_DIV 2

#define ALL_STATE_FLAGS (STATE_TIMEOUT_FLAG | STATE_GPS_FENCE_FLAG | STATE_LOW_BATT_FLAG | STATE_CRIT_BATT_FLAG | STATE_USB_MSB_CONNECTED_FLAG | STATE_USB_MSB_DISCONNECTED_FLAG | STATE_SLEEP_MODE_FLAG | STATE_EXIT_SLEEP_MODE_FLAG | STATE_TAG_RELEASED_FLAG | STATE_SD_CARD_FULL_FLAG)
