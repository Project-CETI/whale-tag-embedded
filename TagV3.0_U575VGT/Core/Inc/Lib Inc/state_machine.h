...
#define IS_SIMULATING_DEBUG false

//Should correspond with the state types enum below
#define SIMULATING_STATE 1

//Flags inside of our state machine event flags
#define STATE_INIT_FLAG					0x1
#define STATE_TIMEOUT_FLAG				0x2
#define STATE_GPS_FENCE_FLAG			0x4
#define STATE_LOW_BATT_FLAG				0x8
#define STATE_CRIT_BATT_FLAG			0x10
#define STATE_USB_MSB_ACTIVATED_FLAG	0x20
#define STATE_USB_MSB_DEACTIVATED_FLAG	0x40
#define STATE_USB_CDC_ACTIVATED_FLAG	0x80
#define STATE_USB_CDC_DEACTIVATED_FLAG	0x100
#define STATE_SLEEP_MODE_FLAG			0x200
#define STATE_EXIT_SLEEP_MODE_FLAG		0x400
#define STATE_TAG_RELEASED_FLAG			0x800
#define STATE_SD_CARD_FULL_FLAG			0x1000
#define STATE_ENTER_SIM_FLAG			0x2000
#define STATE_EXIT_SIM_FLAG				0x4000

#define DATA_OFFLOADING_SD_CLK_DIV 6
#define NORMAL_SD_CLK_DIV 2

#define ALL_STATE_FLAGS (STATE_TIMEOUT_FLAG | STATE_GPS_FENCE_FLAG | STATE_LOW_BATT_FLAG | STATE_CRIT_BATT_FLAG | STATE_USB_MSB_ACTIVATED_FLAG | STATE_USB_MSB_DEACTIVATED_FLAG | STATE_SLEEP_MODE_FLAG | STATE_EXIT_SLEEP_MODE_FLAG | STATE_TAG_RELEASED_FLAG | STATE_SD_CARD_FULL_FLAG)
