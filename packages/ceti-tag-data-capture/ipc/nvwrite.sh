...
i2cset -y 1 0x0b 0xb5 0xc204 w
i2cset -y 1 0x0b 0xb8 0x0830 w
i2cset -y 1 0x0b 0xb9 0x2100 w
i2cset -y 1 0x0b 0xba 0x822d w
i2cset -y 1 0x0b 0xd0 0xa002 w
i2cset -y 1 0x0b 0xd1 0x280a w
i2cset -y 1 0x0b 0xd3 0x03fd w
i2cset -y 1 0x0b 0xd4 0x0caa w
i2cset -y 1 0x0b 0xd6 0x0313 w
i2cset -y 1 0x0b 0xd7 0x0c08 w
i2cset -y 1 0x0b 0xd9 0xec00 w
i2cset -y 1 0x0b 0xda 0xb3a0 w
i2cset -y 1 0x0b 0xdc 0x0035 w
i2cset -y 1 0x0b 0xde 0x4058 w
i2cset -y 1 0x0b 0xb0 0x0290 w
i2cset -y 1 0x0b 0xca 0x71be w
i2cset -y 1 0x0b 0x9e 0x9659 w
i2cset -y 1 0x0b 0xc6 0x5005 w
# 3
i2cset -y 1 0x36 0x61 0x0000 w
# 4
