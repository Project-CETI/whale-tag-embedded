...
#define ACQ_FILE "../data/test_acq_raw.dat"  //for saving short test acquisitions
...
//     * Append "spidev.bufsiz=32768" to the file /boot/cmdline.txt .  Setting will take effect next boot
//     * To see buffer size setting run $ cat /sys/module/spidev/parameters/bufsiz
...
// 	A setting of 500 will give buffer about 10 seconds at a time if sample rate is 48 kHz
// 	Example sizing of buffer (DesignMaps.xlsx has a calcuator for this)
// 		* SPI block HWM * 32 bytes = 16384 bytes (half the hardware FIFO in this example)
// 		* Sampling rate 48000 Hz
// 		* 16 bytes per sample set (4 channels, 24 bits + 8 bit header per channel)
