...
#define WT_ERR_NO_DATA (WT_ERR_IMU_START - 3)
#define WT_ERR_INVALID_CHANNEL (WT_ERR_IMU_START - 4)
#define WT_ERR_INIT_FAILED (WT_ERR_IMU_START - 5)
#define WT_ERR_HW_RESET_FAILED (WT_ERR_IMU_START - 6)
#define WT_ERR_RECOVERY_FAILED (WT_ERR_IMU_START - 7)

#define WT_ERR_IOX_START (WT_ERR_IMU_START - 8)
