...
//  2.3.2   06/23/25   Improve IMU reliability, improve ecg efficiency, faster startup time, improve ntp sync reliability

#ifndef CETI_VERSIONING_H
#define CETI_VERSIONING_H

#define CETI_VERSION "v2_3.1 New hardware design - V2.3"
