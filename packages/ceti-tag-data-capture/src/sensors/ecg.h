...
//-----------------------------------------------------------------------------
// Seems to log about 1GiB every 6.5 hours.
// Note that 2GB is the file size maximum for 32-bit systems
#define ECG_MAX_FILE_SIZE_MB 1024

// One for logging, one for writing.
#define ECG_NUM_BUFFERS 2

// Once a buffer fills, it will be flushed to a file
#define ECG_BUFFER_LENGTH 10000

// Max time to wait for ADC or GPIO expander data to be ready before
// reconnecting the ECG electronics
#define ECG_SAMPLE_TIMEOUT_US 100000

// Max number of samples to tolerate consecutive 0s before reconnecting the ECG
// electronics
