...
// The data-ready line of the ADC.
//   7 for the new ECG board (v1.1), and
//   3 for the old board (v0.9 and v1.0).
#define ECG_GPIO_EXPANDER_CHANNEL_DATAREADY 7

// The leads-off detection output of the ECG chip (positive electrode)
#define ECG_GPIO_EXPANDER_CHANNEL_LEADSOFF_P 1

// The leads-off detection output of the ECG chip (negative electrode)
#define ECG_GPIO_EXPANDER_CHANNEL_LEADSOFF_N 0
...
// Currently, using the LEDs seems to prevent successful reading of the
// data-ready line (and thus raises concerns for reading leads-off detections
// too)
#define ECG_GPIO_EXPANDER_USE_LEDS 0
