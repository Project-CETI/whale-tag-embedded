...
// -1 to use the GPIO expander instead of a direct connection
#define ECG_ADC_DATA_READY_PIN 6
...
// will try to reconfigure ADC if data is not available after this timeout
#define ECG_ADC_DATA_READY_INTERRUPT_TIMEOUT_MS 10
